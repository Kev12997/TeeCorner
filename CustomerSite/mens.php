...
<?php
$option = "normal";
echo '<form action ="includes/sortByMens.inc.php" method="GET">
...
if($page == "" || $page == "1"){
  ...
  include 'includes/sortMen.inc.php';
  
  $result3 = mysqli_query($conn,$sql);
  //echo("/SELECT * FROM shirt WHERE gender ='male'");
...
{ //fetch query result as array
  ...
  while($row = mysqli_fetch_array($result))
  {
    ...
    <div class="col-md-4">
      ...
      $rowTest = mysqli_fetch_array($resultTest);
         echo'<a href="Mshirt_preview.php?id='.$id[$count].'"><img src="shirts/'.$rowTest['imgfront'].'"></a>
          <div class="caption">
  ...
  $sqlPage = "SELECT * FROM shirt WHERE gender ='male' and shirt_status = 'ACTIVE'"; //select male shirts
...
echo '<ul class="pagination pagination-lg">';
  for($b=1;$b<=$a;$b++)
  {
    ?><li><a href="mens.php?page=<?php echo($b); ?>" style = "text-decoration:none"><?php echo $b." ";?></a><li> <?php
  }
  echo'</ul>';
?>
