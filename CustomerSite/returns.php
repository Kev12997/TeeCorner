    ...
    <div class="col-sm-7 col-sm-offset-2">
      <div class="panel panel-info">
        ...
        <div class="panel-body">
				<form class = "signup-form" action="includes/return.inc.php" method="POST">
					<div class="input-group">
					<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
					<input id="orderId" type="text" class="form-control" name="orderId" placeholder="Order Id">
				  </div>
				    <div class="input-group">
					<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
					<input id="shirtId" type="text" class="form-control" name="shirtId" placeholder="Shirt Id">
				    </div>
                    <div class="form-group">
                    <label for="issue">Why do you wish to return this item?:</label>
                    <textarea class="form-control" rows="5" name="issue"></textarea>
                    </div>
				  </div>
                    <button type="submit" name="submit" class="btn btn-info">Return Item</button>
                    <?php //echo nl2br("\n/INSERT INTO user_returns(order_id, shirt_id, return_status, request_date, issue) VALUE ('$/orderId', '$/shirtId', 'PENDING','$/requestDay', '$/issue');");  ?>
				</form>
</html>